...
//register route
  register: (req, res) => {
    ...
    console.log(register_json.userName, register_json.email, register_json.password);
...
//logIn route
  ...
  //Assuming rafid11elahi@gmail.com and password is 12345678
    if(email == `rafid11elahi@gmail.com` ){
      password == `12345678`? res.send('You can enter Your profile') : res.send('Your password was incorrect')
    }
    else {
      res.send(`The password is incorrect. If you are new to Teebay. Please Register First`)
  }},
